...
function StudentCourseDetails() {
  ...
  return (
    ...
    <div style={{display:"flex", flexDirection:"row",justifyContent:"center",alignItems:"center"}}>
      <Card sx={{
        backgroundImage: 'url(https://img.freepik.com/free-vector/winter-blue-pink-gradient-background-vector_53876-117275.jpg?t=st=1731558231~exp=1731561831~hmac=1ed06fb03faacf93e496b9041ab3d0f1f153a7518ee4224331dd8c92a3a9cfc6&w=740)', backgroundSize: 'cover', backgroundPosition: 'center',
        ...
        <Container sx={{ display: "flex", flexDirection: "row", gap: 2, justifyContent: "end", alignItems: "center" }}>
          ...
          {/* <Button variant='contained' onClick={()=>handleDelete(course._id)} >delete</Button> */}
          <Button variant='contained' sx={{backgroundImage:"radial-gradient(circle at 85.4% 50.8%, rgb(14, 72, 222) 0%, rgb(3, 22, 65) 74.2%)"}} onClick={onApply} >Apply</Button>
        </Container>
      </Card>
      <StudentApplicationForm open={formOpen}
        courseData={course}
